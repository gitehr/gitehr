...
- [ ] **R59 - Publish a patient-mediated extraction position statement:** explain the local-first, own-data, adversarial-interoperability, and safety posture for portal extraction.
