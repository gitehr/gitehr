...
- `/fhir` – FHIR v5 content: compiled resource definitions, concrete resource instances, and optional derived indexes (see [folder-structure/fhir/README.md](../../folder-structure/fhir/README.md) and [fhir.md](fhir.md)). Scaffolding and conventions only for now; commands arrive with R12-R14.
