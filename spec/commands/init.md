...
5. Records the version of GitEHR used for initialization in a `GITEHR_VERSION` file inside `.gitehr`.
6. Creates a placeholder file `.gitehr/GITEHR_BINARY_PLACEHOLDER` to mark future binary bundling work.
